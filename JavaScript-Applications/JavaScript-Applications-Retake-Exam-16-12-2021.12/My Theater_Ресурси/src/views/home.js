...
const homeTemplate = (listing) => html`
...
export async function homePage(ctx) {
    ...
    ctx.render(homeTemplate(listing));
}

const listingPreview = (listing) => html`
<div class="eventsInfo">
    ...
    <div class="info">
        ...
        <h6 class="date">${listing.date}</h6>
        <h6 class="author">${listing.author}</h6>
        <div class="info-buttons">
            <a class="btn-details" href="/details/${listing._id}">Details</a>
        </div>
    </div>
</div>`;